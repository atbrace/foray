...
4. **Identify 3-5 exploration paths** — independent questions with uncertain answers for Foray to investigate.
...
- Target **3-5 paths**. Fewer focused paths beat many shallow ones. Resist padding.
